...
if ($ticket_id <= 0) {
    header('Location: /Modules/Tickets/tickets.php');
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$error) {
    try {
        ...
        if ($result) {
            ...
            header("refresh:2;url=/Modules/Tickets/view_ticket.php?id=$ticket_id");
        } else {
        ...
        <div class="ticket-form-container">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="text-center">
                    ...
                    <a href="/Modules/Tickets/view_ticket.php?id=<?php echo $ticket_id; ?>" class="btn btn-secondary ml-3" style="border-radius: 25px; padding: 15px 30px; border: 1px solid var(--border-color);">
                        <i class="fas fa-eye mr-2"></i>
                        Ver Ticket
                    </a>
                    <a href="/Modules/Tickets/tickets.php" class="btn btn-outline-secondary ml-3" style="border-radius: 25px; padding: 15px 30px; border: 1px solid var(--border-color);">
