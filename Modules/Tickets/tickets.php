    ...
    <div class="container">
        ...
        <div class="tickets-header">
            ...
            <div class="text-center">
                <a href="/Modules/Tickets/new_ticket.php" class="btn btn-primary btn-lg" style="background: linear-gradient(135deg, var(--primary-color) 0%, var(--info-color) 100%); border: none; border-radius: 25px; padding: 12px 30px;">
        ...
        <div class="filters-section">
            <form method="GET" class="row">
                ...
                <div class="col-md-<?php echo $is_superadmin ? '3' : '3'; ?> mb-3 d-flex align-items-end">
                    ...
                    <a href="/Modules/Tickets/tickets.php" class="btn btn-secondary" style="border: 1px solid var(--border-color);">
        ...
        <div class="tickets-container">
            <?php if (empty($tickets)): ?>
                <div class="empty-state">
                    ...
                    <a href="/Modules/Tickets/new_ticket.php" class="btn btn-primary" style="background: linear-gradient(135deg, var(--primary-color) 0%, var(--info-color) 100%); border: none; border-radius: 25px;">
                        <i class="fas fa-plus mr-2"></i>
                        Crear Primer Ticket
                    </a>
                </div>
                    ...
                    <div class="ticket-card <?php echo $ticket['is_urgent'] ? 'urgent' : ''; ?>">
                        ...
                        <div class="ticket-footer">
                            ...
                            <div class="ticket-actions">
                                <a href="/Modules/Tickets/view_ticket.php?id=<?php echo $ticket['id_ticket']; ?>" class="btn-ticket btn-primary-ticket">
                                    <i class="fas fa-eye"></i>
                                    Ver
                                </a>
                                <a href="/Modules/Tickets/edit_ticket.php?id=<?php echo $ticket['id_ticket']; ?>" class="btn-ticket btn-secondary-ticket">
